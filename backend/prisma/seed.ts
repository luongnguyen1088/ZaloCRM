  ...
  const plans = [
    {
      ...
      maxZaloAcc: 1,
      maxAiTokens: 150000,
      features: JSON.stringify(['CRM cơ bản', '1 kênh kết nối', 'AI Assistant (Model cơ bản)', '~100 lượt phản hồi AI/tháng']),
    },
    {
      name: 'Pro',
      priceMonth: 250000,
      maxZaloAcc: 3,
      maxAiTokens: 2500000,
      features: JSON.stringify(['Đầy đủ CRM', '3 kênh kết nối', 'AI Assistant (Tốc độ cao)', 'Automation', '~1,600 lượt phản hồi AI/tháng']),
    },
    {
      name: 'Business',
      priceMonth: 650000,
      maxZaloAcc: 15,
      maxAiTokens: 8000000,
      features: JSON.stringify(['Đầy đủ CRM', '15 kênh kết nối', 'Quản lý Team & Phân quyền', '500k Premium Tokens', '~5,300 lượt phản hồi AI/tháng']),
    },
    {
      name: 'Enterprise',
      priceMonth: 2000000,
      ...
      features: JSON.stringify(['Vô hạn CRM', '50 kênh kết nối tối đa', 'Claude 3.5 Sonnet (5M Premium Tokens)', 'Ưu tiên hỗ trợ 24/7', '~20,000 lượt phản hồi AI/tháng']),
    },
  ];
