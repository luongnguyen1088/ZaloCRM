...
10. [Nâng cấp & Thanh toán](#10-nâng-cấp--thanh-toán)
...
### Cách nâng cấp gói cước

1. Nhấn vào **biểu tượng vương miện** hoặc vào menu **Bảng giá**.
2. Chọn gói cước phù hợp (Standard, Pro, Enterprise).
3. Nhấn **Nâng cấp ngay** → Dialog thanh toán hiện ra.

### Thông tin chuyển khoản

| Trường | Thông tin |
|--------|-----------|
| **Chủ tài khoản** | CÔNG TY TNHH CLARO VIỆT NAM |
| **Ngân hàng** | MB Bank (Ngân hàng Quân Đội) |
| **Số tài khoản** | `6386365999` |
| **Nội dung** | `CRMPAY [Tên gói]` |

### Kích hoạt tự động

- Hệ thống sử dụng công nghệ **VietQR** để nhận diện giao dịch tự động.
- Gói cước sẽ được kích hoạt ngay sau khi tiền vào tài khoản (thường trong 1-3 phút).
